...
function edit(e) {
  ...
  fetch(
    `https://powerful-cove-00684.herokuapp.com/edit-product/${product_id}/`,
...
function deleteP(e) {
  fetch(
    `https://powerful-cove-00684.herokuapp.com/delete-product/${e.parentElement.parentElement.id}/`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
function add() {
  ...
  console.log(name, cat, desc, price);
  ...
  fetch(
    `https://powerful-cove-00684.herokuapp.com/add-product/${parseInt(
    ...
    .then((res) => {
      if (!res.ok) {
        throw new Error("please use different image");
      }
      res.json();
    })
    .then((data) => {
